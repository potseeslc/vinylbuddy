...
exports.Device = exports.Request = exports.ShazamURLS = void 0;
const useragents_js_1 = require("./useragents.cjs");
class ShazamURLS {
...
class Request {
    static headers(language = 'en') {
        return {
            ...
            'User-Agent': `${useragents_js_1.USER_AGENTS[Math.floor(Math.random() * useragents_js_1.USER_AGENTS.length)]}`
        };
    }
}
