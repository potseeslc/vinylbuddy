...
class Endpoint {
    ...
    headers(language = 'en') {
        return requests_js_1.Request.headers(language);
    }
...
class Shazam {
    ...
    async fromFilePath(path, minimal = false, language = 'en') {
        await (0, to_pcm_js_1.convertfile)(path);
        const data = fs_1.default.readFileSync('node_shazam_temp.pcm');
        const conv = (0, utils_js_1.s16LEToSamplesArray)(data);
        fs_1.default.unlinkSync('node_shazam_temp.pcm');
    ...
    async fromVideoFile(path, minimal = false, language = 'en') {
        await (0, to_pcm_js_1.tomp3)(path);
        const res = await this.fromFilePath('node_shazam_temp.mp3', minimal, language);
        fs_1.default.unlinkSync('node_shazam_temp.mp3');
        return res;
    }
    /**
     * @deprecated
    ...
    async recognizeSongMinimal(samples, language = 'en', callback) {
        ...
        const title = trackData.title, artist = trackData.subtitle, album = mainSection.metadata.find(e => e.title === 'Album')?.text, year = mainSection.metadata.find(e => e.title === 'Released')?.text;
    ...
    async recognise(path, language = 'en-US', minimal = false) {
        const signatures = (0, shazamio_core_1.recognizeBytes)((0, fs_2.readFileSync)(path), 0, Number.MAX_SAFE_INTEGER);
        let response;
    ...
    createSignatureGenerator(samples) {
        const signatureGenerator = new algorithm_js_1.SignatureGenerator();
    ...
    async top_tracks_global(language = 'en-US', endpoint_country = 'GB', limit = '10', offset = '0') {
        const url = requests_js_1.ShazamURLS.top_tracks_global(language, endpoint_country, limit, offset);
    ...
    async top_tracks_country(language, endpoint_country, country_code, limit, offset) {
        const url = requests_js_1.ShazamURLS.top_tracks_country(language, endpoint_country, country_code, limit, offset);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
    ...
    async top_tracks_city(language, endpoint_country, city_id, limit, offset) {
        const url = requests_js_1.ShazamURLS.top_tracks_city(language, endpoint_country, city_id, limit, offset);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
     * Info about a track
    ...
    async track_info(language, endpoint_country, track_id) {
        const url = requests_js_1.ShazamURLS.track_info(language, endpoint_country, track_id);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
     * List locations
    ...
    async list_locations() {
        const url = requests_js_1.ShazamURLS.locations();
    ...
    async top_genre_tracks_world(language, endpoint_country, genre, limit, offset) {
        const url = requests_js_1.ShazamURLS.genre_world(language, endpoint_country, genre, limit, offset);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
     * Most shazamed tracks for a country
    ...
    async top_genre_tracks_country(language, endpoint_country, country, genre, limit, offset) {
        const url = requests_js_1.ShazamURLS.genre_country(language, endpoint_country, country, genre, limit, offset);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
    ...
    async related_songs(language, endpoint_country, track_id, offset, limit) {
        const url = requests_js_1.ShazamURLS.related_songs(language, endpoint_country, track_id, offset, limit);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
    ...
    async search_artist(language, endpoint_country, query, limit, offset) {
        const url = requests_js_1.ShazamURLS.search_artist(language, endpoint_country, query, limit, offset);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
     * Search artist by id
    ...
    async search_artist_v2(endpoint_country, artist_id) {
        const url = requests_js_1.ShazamURLS.search_artist_v2(endpoint_country, artist_id);
        return await (await fetch(url, { headers: this.headers(), method: 'GET' })).json();
    }
    /**
     * Albums by an artist
    ...
    async artist_albums(endpoint_country, artist_id, limit, offset) {
        const url = requests_js_1.ShazamURLS.artist_albums(endpoint_country, artist_id, limit, offset);
        return await (await fetch(url, { headers: this.headers(), method: 'GET' })).json();
    }
    /**
    ...
    async search_music(language, endpoint_country, query, limit, offset) {
        const url = requests_js_1.ShazamURLS.search_music(language, endpoint_country, query, limit, offset);
        return await (await fetch(url, { headers: this.headers(language), method: 'GET' })).json();
    }
    /**
    ...
    async listen_count(track) {
        const url = requests_js_1.ShazamURLS.listening_counter(track);
        return await (await fetch(url, { headers: this.headers(), method: 'GET' })).json();
    }
}
